...
def build_streamlit_app_source(
    ...
    *,
    ...
    if interaction_mode == "coaching":
        return _build_coaching_streamlit_app_source(service_name, content_filename)
...
def _build_coaching_streamlit_app_source(service_name: str, content_filename: str) -> str:
    return textwrap.dedent(
        f'''
        from __future__ import annotations
